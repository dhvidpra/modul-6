...
if($_POST){
    ...
    if(empty($nama_petugas)){
        ...
        if(empty($password)){
            ...
            $update=mysqli_query($conn,"update petugas set nama_petugas='".$nama_petugas."',username='".$username."', telp='".$password."', level='".$level." ") or die(mysqli_error($conn));
            ...
            if($update){
                ...
                echo "<script>alert('Gagal update produk');location.href='ubah_produk.php?id_pelanggan=".$id_produk."';</script>";
